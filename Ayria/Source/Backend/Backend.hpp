...
{
    // static void __cdecl Callback(uint32_t NodeID, uint32_t Length, const char *Message);
    using Callback_t = void(__cdecl *)(uint32_t NodeID, uint32_t Length, const char *Message);
