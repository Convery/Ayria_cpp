...
namespace Steam
{
    ...
    namespace Callbacks
    {
        ...
        struct JoinClanChatRoomCompletionResult_t { CSteamID m_steamIDClanChat; enum EChatRoomEnterResponse : uint32_t m_eChatRoomEnterResponse; };
        ...
        struct RegisterActivationCodeResponse_t { enum ERegisterActivationCodeResult : uint32_t m_eResult; uint32_t m_unPackageRegistered; };
        ...
        struct GSClientDeny_t { CSteamID m_SteamID; enum EDenyReason : uint32_t m_eDenyReason; char m_rgchOptionalText[128]; };
        struct GSClientKick_t { CSteamID m_SteamID; enum EDenyReason : uint32_t m_eDenyReason; };
