...
void Tencent_init()
{
    ...
    // Override the anti-cheat initialization.
    Originalresource = GetProcAddress(LoadLibraryA("./IIPS/iips.dll"), "GetResourceManagerII");
    Mhook_SetHook(&Originalresource, GetResourceManager);

    //Hook("./IIPS/iips.dll", "GetResourceManager", GetResourceManager);
    //Hook("./IIPS/iips.dll", "GetResourceManagerII", GetResourceManager);
}
