...
namespace Base58
{
	constexpr size_t Decodesize(size_t N) { return (N * 733 / 1000) + 1; }  // log(58) / log(256), rounded.
	constexpr size_t Encodesize(size_t N) { return (N * 138 / 100) + 1; }   // log(256) / log(58), rounded.
